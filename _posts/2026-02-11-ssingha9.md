...
# Keep first 10 PCs for clustering (from elbow of scree plot)
n_pcs <- 10
top_PCs <- PCs$x[, 1:n_pcs]

# STEP 3: Determine optimal number of clusters using TWSS elbow method discussed in lecture
...
# Apply formatting to each panel

# p1: remove legend, center title
p1_fix <- fix_panel(
  p1,
  title = "Cluster 5 in tSNE", 
  legend_pos = "none"
...
# p3: keep legend, center title and subtitle
p3_fix <- fix_panel(
  p3,
...
# Assemble figure in 3 rows with equal widths
# Row 1: cluster visualizations (p1, p2)
# Row 2: differential expression bar plots (p3, p6)
# Row 3: marker gene expression (p4, p5)
...
# Combine rows and add overall title
