...
I use points as the geometric primitive. As for visual channel, I use x-axis and y-axis position to encode location for each spot and use color intensity (both hue and saturation) to encode the continuous expression level of the gene. 

### 3. What about the data are you trying to make salient through this data visualization? 
I’m trying to make salient where spots with high expression of canonical markers (Part et al., 2018) and top spatially variable genes.
